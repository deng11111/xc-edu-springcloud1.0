...
docker rmi swr.cn-east-2.myhuaweicloud.com/xc-edu-demo/xc-service-portalview:$1
...
docker tag xc-service-portalview:1.0-SNAPSHOT swr.cn-east-2.myhuaweicloud.com/xc-edu-demo/xc-service-portalview:$1
#执行docker push 将本地服务器上的镜像推送到云平台镜像仓库
docker push swr.cn-east-2.myhuaweicloud.com/xc-edu-demo/xc-service-portalview:$1
